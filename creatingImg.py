...
def createImg(medName, camera):
    ...
    while True:
        ...
        if key == ord("k"):
            ...
            cv2.imwrite("Images/" + medName + "-" + str(numberOfImage) + ".jpg", croppedImage)
            cv2.putText(createdDataImage, 'Images:  ' + str(numberOfImage), (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0), 3)
